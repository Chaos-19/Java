...
System.out.println("TOH --  " + Arrays.toString(src.array));
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Srce  " + Arrays.toString(src.array));
        System.out.println("Dest  " + Arrays.toString(dest.array));
        System.out.println("Temp  " + Arrays.toString(src.array));
